...
<body>
    ...
    @section('content')
        <section class="p-category">
            <a href="{{ url('products', ['category' => 'Fruits and Vegetable']) }}">Fruits and Vegetable</a>
            <a href="{{ url('products', ['category' => 'Meat and Fish']) }}">Meat and Fish</a>
            <a href="{{ url('products', ['category' => 'Spice']) }}">Spice</a>
            <a href="{{ url('products', ['category' => 'Other Ingredients']) }}">Other Ingredients</a>
        </section>
            ...
            <div class="box-container">
                @if (count($products) > 0)
                    @foreach ($products as $product)
                        <form action="shop" class="box" method="post" enctype="multipart/form-data">
                            @csrf
